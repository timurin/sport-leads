"""upgrade technical card print form to landscape v2 layout
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .pf-block { border: 1px solid #d1d5db; border-radius: 10px; padding: 8px 10px; }
    .pf-block--fill { flex: 1; min-height: 0; display: flex; flex-direction: column; }
    ...
    .pf-table th, .pf-table td { border: 1px solid #d1d5db; padding: 5px 7px; vertical-align: top; text-align: left; }
