...
| Микрозадача | Содержание | Статус |
|---|---|---|
| `5.4.2.3.1` | Зафиксировать стандарт (этот ADR) | done |
| `5.4.2.3.2` | Shared `CreateDrawer` shell | done |
| `5.4.2.3.3` | Номенклатура / категория → CreateDrawer | done |
| `5.4.2.3.4` | Лид → CreateDrawer | done |
