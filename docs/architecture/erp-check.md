...
- `[ ]` **v1.00 Stage `26` owner findings** — living bugs/cosmetics backlog; `26.0.1` closed `2026-08-25`; **`26.1.1`–`26.1.6` closed `2026-08-26`**; **`26.2.1`–`26.2.2` closed `2026-08-26`**; **`26.3.1`–`26.3.13` closed `2026-08-26`/`2026-08-28`**; **`26.4.1`–`26.4.3` closed `2026-08-26`**; **`26.5.1`–`26.5.4` closed `2026-08-26`**; **`26.6.1`–`26.6.8` closed `2026-08-26`**; **`26.7.1` closed `2026-08-26`**; **`26.8.1`–`26.8.2` closed `2026-08-26`**; **`26.9.1`–`26.9.3` closed `2026-08-27`** (owner visual nav + settings slider); **`26.10.1`–`26.10.8` closed `2026-08-28`** (catalog slim; ADR-014/029; assembly inline edit); current slice is `12.5.1.6`; ≠ reopen `20` / `22` / `3.5` / `19`;
