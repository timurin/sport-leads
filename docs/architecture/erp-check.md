...
- `[x]` `4.8` / ADR-015 (partial): unified `Characteristic*` catalog — migration `f7a8b9c0d123`, `/custom-fields` API unmounted, DELETE + usage guards + `18.4` journal stub, nav redirect (`4.8.1`–`4.8.3`, `4.8.5`); detail card **layout confirmed** (`4.8.4`); open: appearance/content polish (follow-up), UI rename/compat cleanup `4.8.6`, orphan module cleanup + focused regression (`4.8.7`);
...
Canonical sync `2026-07-23`: erp-check aligned with roadmap honesty for `4.8` (partial), product types `6.1.14`–`6.1.16`, sewing `6.3.8`, ADR-016 tech-card reserve, and warehouse `4.6.5` instead of legacy Material stock.
