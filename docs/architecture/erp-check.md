...
- `[ ]` **v1.00 Stage `26` owner findings** — living bugs/cosmetics backlog; `26.0.1` closed `2026-08-25`; **`26.1.1`–`26.1.6` closed `2026-08-26`**; **`26.2.1`–`26.2.2` closed `2026-08-26`**; **`26.3.1`–`26.3.15` closed `2026-08-26`/`2026-08-29`**; **`26.4.1`–`26.4.3` closed `2026-08-26`**; **`26.5.1`–`26.5.4` closed `2026-08-26`**; **`26.6.1`–`26.6.8` closed `2026-08-26`**; **`26.7.1` closed `2026-08-26`**; **`26.8.1`–`26.8.2` closed `2026-08-26`**; **`26.9.1`–`26.9.3` closed `2026-08-27`** (owner visual nav + settings slider); **`26.9.4`–`26.9.5` closed `2026-08-29`** (hub links leave slider; topbar dropdown portal); **`26.10.1`–`26.10.8` closed `2026-08-28`** (catalog slim; ADR-014/029; assembly inline edit); **`26.11.1`–`26.11.14` closed `2026-08-29`** (list/tabs; owner visual pending responsible + Заказ); **`26.12.1`–`26.12.2` closed `2026-08-29`**; **`26.13.1`–`26.13.6` closed `2026-08-31`** (ADR-035 detailing + model Materials + TC prefill; owner visual OK); owner-pull; Stage `13.1.1` closed; ≠ reopen `20` / `22` / `3.5` / `19`;
...
- `[x]` `4.4.6` variant pricing / barcodes / external_code: nullable `price` (override `base_price`), unique `barcode`, opaque `external_code` (optional; 1С **export** = Stage **`27`**, not an entry gate); Alembic `b9c0d1e2f345`; card «Варианты» removed `26.4.3`; order suggests variant price; evidence `test_variant_pricing_4_4_6.py`;
...
- `[~]` **warehouse Stage 12** — ADR-019; `12.1`–`12.3` shipped in `v0.9.0`; inventory `12.4` closed `2026-08-26` (owner visual `12.4.1.6`); transfers `12.5.1` closed `2026-08-29` (owner visual `12.5.1.6`); reserves `12.5.2` later;
...
- `[x]` операции пошива (каталог) + связка со строками варианта — `6.3.1`–`6.3.6` shipped; normative `duration_seconds` + assembly-line snapshot `6.3.8` shipped; equipment M:N (цех Пошив) `6.3.10` shipped; folder tree `6.3.11` + templates `6.3.12` + apply to assembly `6.3.13` shipped (owner visual OK `2026-08-02`); **`26.10` shipped** (leaf slim; economics on `AssemblyOperationLine`; pick 0/1/0; inline edit; cabinet snapshot);
...
- `[x]` **кабинет швеи (`v1.00` Stage `24`)** — закрыт `2026-08-24` (owner visual `24.5.2`); ADR-029 + `SL-SEWING-CABINET-v1`; `PlatformUser`; журнал + ограниченная оболочка; ≠ `2.4.2` Employee; **`26.10.7` shipped:** `operation` `unit_price` from assembly snapshot / variant line;
...
- `[x]` **standalone ТК + нумерация (`v1.00` Stage `28`)** — `28.0.1`–`28.5.4` closed `2026-08-27` (owner visual `28.3.3` OK);
...
- `[~]` единицы измерения как единый справочник, склады, зоны, резервы, партии и инвентаризация — склады + регистр `12.1`/`12.2` shipped; инвентаризация `12.4` закрыта `2026-08-26` (owner visual `12.4.1.6`); зоны/лоты/резервы later;
- `[ ]` фактическое списание и выпуск;
- `[~]` закупки, поставщики и заказы поставщикам — Stage `13.1.1` closed `2026-08-29`; Stage `13.1.2` FE shipped (`r7s8t9u0v123`, `/purchase-orders`); owner visual `13.1.2.6` pending;
...
- `[x]` **Canonical VPS workflow (`v1.00` `0.5`)** — ADR-032; Ubuntu 26.04 + clone + TLS + dump + GitHub deploy (`push` to `main`) + cron; smoke `https://sport-lead.ru/login` `2026-08-25`;
...
- `[ ]` обмен с 1С: пакеты заказ покупателя / утверждённая спецификация / ТН-УПД (Stage **`27`**, ADR-020 contour D); сопоставление справочников в УНФ; inbound `16.2.1` припаркован;
- `[x]` каталожный file I/O номенклатуры (`4.5.1`/`4.5.2`) + модели изделий (`4.5.3`) + операции пошива (`4.5.4`, owner visual OK `4.5.4.4` `2026-08-24`) — section toolbar + shared parse lib (ADR-020); domain inline (`9.3.2`) отдельно; **`26.10.3` broke sewing I/O columns** (drop cost/qty/duration; add `description`);
