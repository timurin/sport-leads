...
- `[~]` **Design v1.0 (`v1.00` Stage `22`)** — Soft UI HTML etalons → platform; process `SL-DESIGN-V1-PROCESS-v1`; live Lead + Order + Production + Warehouse OK (`22.5.4`); etalons `22.4`–`22.9` owner OK; next Purchases contract `22.6.2`; live `DS-SHELL` frozen until `22.9.2`–`22.9.3`; Sales boards TBD `22.3`; do not re-open Stage `20` data contracts;
