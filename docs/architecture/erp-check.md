...
- `[ ]` **v1.00 Stage `26` owner findings** — living bugs/cosmetics backlog; `26.0.1` closed `2026-08-25`; **`26.1.1`–`26.1.6` closed `2026-08-26`**; **`26.2.1`–`26.2.2` closed `2026-08-26`**; **`26.3.1`–`26.3.4` closed `2026-08-26`**; **`26.4.1`–`26.4.3` closed `2026-08-26`**; **`26.5.1`–`26.5.4` closed `2026-08-26`**; **`26.6.1`–`26.6.8` closed `2026-08-26`**; **`26.7.1` closed `2026-08-26`**; **`26.8.1`–`26.8.2` closed `2026-08-26`**; **`26.9.1`–`26.9.2` closed `2026-08-27`**; **`26.9.3` parked** (owner visual nav + settings slider); current slice is `12.5.1`; ≠ reopen `20` / `22` / `3.5` / `19`;
...
- `[~]` **warehouse Stage 12** — ADR-019; `12.1`–`12.3` shipped in `v0.9.0`; inventory `12.4` closed `2026-08-26` (owner visual `12.4.1.6`); transfers/reserves `12.5` open;
