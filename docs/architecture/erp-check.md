...
- `[~]` **warehouse Stage 12** — ADR-019; `12.1`–`12.3` shipped in `v0.9.0`; inventory `12.4` closed `2026-08-26` (owner visual `12.4.1.6`); transfers `12.5.1.1`–`12.5.1.5` shipped `2026-08-27`; owner visual `12.5.1.6` open; reserves `12.5.2` later;
