...
- `[ ]` **v1.00 Stage `26` owner findings** — living bugs/cosmetics backlog; `26.0.1` closed `2026-08-25`; **`26.1.1`–`26.1.2` closed `2026-08-26`**; **`26.4.1`–`26.4.3` closed `2026-08-26`**; **`26.5`** lead layout A open (visual `26.5.2`); remaining seed parked; **owner-pull only**; current slice is `12.5.1`; ≠ reopen `20` / `22` / `3.5` / `19`;
...
- `[x]` `4.4.6` variant pricing / barcodes / external_code: nullable `price` (override `base_price`), unique `barcode`, opaque `external_code` (1С → `16.2.1`); Alembic `b9c0d1e2f345`; card «Варианты» removed `26.4.3`; order suggests variant price; evidence `test_variant_pricing_4_4_6.py`;
