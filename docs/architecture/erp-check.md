...
- `[~]` модели и артикулы — Stage 6 catalog v1 closed (`6.1.1`–`6.1.12`, `6.2.*`, `6.3.*`, `6.4`); order-item binding moved to Stage `3.2.5` / smoke `3.2.6` (open);
...
- `[x]` операции пошива (каталог) + связка со строками варианта — `6.3.1`–`6.3.6` shipped; owner visual OK (`2026-07-22`);
