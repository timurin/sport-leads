...
- `[~]` **Canonical VPS workflow (`v1.00` `0.5`)** — ADR-032; host **Ubuntu 26.04** live (`0.5.4.1`: Docker `29.7.2` + Compose `v5.5.0`, UFW `22/80/443`); git gate `0.5.3` closed; public origin **`https://sport-lead.ru`** (`0.5.6.1` DNS open); clone + owner smoke open (`0.5.4`/`0.5.6`–`0.5.8`/`0.5.11`–`0.5.12`);
