...
- `[~]` **v1.00 Stage `23` Unified Work Tasks** — ADR-028; through `23.6.2` (API/FE/hosts + data migrate `p9q0r1s2t345` + docs checkpoint); **next `23.6.3` owner visual**; old tables retained;
