...
**Roadmap:** `4.5`, `9.3.2`, `1.4`, `16.2` / `16.3`, Stage **`27`**; project-structure §5 / §12
...
|------|---------|---------------------|--------|---------|
| **A** | Catalog file I/O | `4.5.1` / `4.5.2` / `4.5.3` / `4.5.4`; project-structure §5 «import, and export» | adapters (owner visual OK `4.5.4.4` `2026-08-24`) | Пакетный файл ↔ мастер-справочник (номенклатура + модели изделий + операции пошива); universal jobs → `16.3` |
...
| **D** | System exchange + universal jobs | **`27.*` 1C:UNF outbound** (packages; matching in УНФ); `16.2.1` inbound UNF→platform **parked**; `16.3.*` universal job shell; project-structure «Universal import and export» / «1C exchange» | open | Внешняя ERP (выгрузка = Stage 27) + кросс-модульный job runner |
...
3. Синхронизация с внешней ERP → contour **D** (Stage **`27`** outbound; `16.2.1` inbound parked), не `4.5`.
