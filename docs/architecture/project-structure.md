...
**Updated:** `2026-08-22` (Stage `22.5.4` Warehouse live OK; next `22.6.2`; Stage `23` through `23.7`/`23.10.4`)  
...
- [ ] Design v1.0 (`v1.00` Stage `22`) — Soft UI etalons → platform; `SL-DESIGN-V1-PROCESS-v1`; Lead/Order/Production/Warehouse live OK `22.5.4`; next Purchases `22.6.2`; etalons `22.4`–`22.9` owner OK; live shell after `22.9.2`; TBD boards `22.3`; task `docs/tasks/v1.00-stage-22-design-v1.md`
