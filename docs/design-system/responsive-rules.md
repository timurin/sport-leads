...
- PT-02 Catalog List: `docs/design-system/pt-02-catalog-list.md` (`DS-PT-02-CATALOG`) — directories / sections / categories; etalon `/settings/catalogs/product-models`.
...
- PT-08 Catalog Card: `docs/design-system/pt-08-catalog-card-layout.md` (`DS-PT-08-CATALOG`) — etalon `/settings/catalogs/product-models/[id]`.
