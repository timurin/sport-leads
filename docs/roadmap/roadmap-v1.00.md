...
**Updated:** `2026-08-29` (Stage **12.5.1.1**–`12.5.1.5` transfer shipped; next **12.5.1.6** owner visual; parked `0.5.13` S3 media; Stage **26** `26.9.1`–`26.9.3` closed, **`26.3.5`–`26.3.15` closed**, **`26.10.1`–`26.10.8` closed**, **`26.11.1`–`26.11.13` closed** (owner visual pending list responsible + Заказ); Stage **27** 1C:UNF export parked; **Stage 28** closed including `28.5.1`–`28.5.4`)
