  ...
  return (
    <div className="min-w-0">
      ...
      <div className="space-y-5 p-4 sm:p-6">
        ...
        <div className="grid min-w-0 gap-5 xl:grid-cols-4"><LeadSourcesTable sources={snapshot.sources} /><SalesStatusSummary statuses={snapshot.dealStatuses} /><OrdersSummary orders={snapshot.orders} /></div>
