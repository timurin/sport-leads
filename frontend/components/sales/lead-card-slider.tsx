...
/**
 * Bitrix-style CRM slider: list stays dimmed; lead card overlays from the right.
 */
export function LeadCardSlider({ children }: { children: ReactNode }) {
    ...
    <div className="fixed inset-0 z-portal-modal-2">
      ...
      >
        <div className="absolute left-0 top-3 z-10 -translate-x-1/2">
          <IconButton label="Закрыть" onClick={close} className="border border-portal-border bg-portal-surface shadow-portal-sm">
