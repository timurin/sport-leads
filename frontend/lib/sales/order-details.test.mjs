...
test("maps persisted order details and preserves nullable fields", () => {
  const order = fromApiSalesOrder({
    ...
    items: [{ id: 7, order_id: 42, material_id: null, position: 1, name: "Матчевка", unit: "шт", quantity: "2", unit_price: "1500", line_total: "3000", created_at: "2026-07-18T10:00:00Z", updated_at: "2026-07-18T10:00:00Z" }],
  });
  ...
  assert.equal(order.items[0].lineTotal, "3 000,00 ₽");
