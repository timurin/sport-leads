...
DEV_LEADS: tuple[SeedLead, ...] = (
    ...
    SeedLead(
        id=1006,
        status=LeadStatus.NEW,
        contact_name="Elena Sokolova",
        company_name="Dev Hockey Meteor",
        customer_type=LeadCustomerType.COMPANY,
        tax_id=None,
        website=None,
        phone="+79001006001",
        ...
        address=None,
        customer_comment="Requests winter collection options.",
        source="email",
        responsible_id=102,
        sport="Hockey",
        product_category="Warm-up suits",
        need_description="Warm-up suits for the junior team.",
        estimated_quantity=42,
        estimated_amount=Decimal("410000.00"),
        desired_date=date(2026, 9, 30),
    ),
    SeedLead(
        id=1007,
        status=LeadStatus.CONTACT,
        contact_name="Mikhail Lebedev",
        company_name="Dev Basketball North",
        customer_type=LeadCustomerType.COMPANY,
        tax_id=None,
        website="north-basket-dev.example.test",
        phone="+79001007001",
        email="mikhail.lebedev@example.test",
        city="Arkhangelsk",
        ...
        sport="Basketball",
        product_category="Game uniform",
        need_description="Uniform refresh for the next season.",
        estimated_quantity=30,
        estimated_amount=Decimal("295000.00"),
        desired_date=date(2026, 10, 20),
    ),
    SeedLead(
        id=1008,
        status=LeadStatus.QUALIFICATION,
        contact_name="Sofia Volkova",
        company_name="Dev Tennis Academy",
        customer_type=LeadCustomerType.COMPANY,
        tax_id=None,
        website=None,
        phone="+79001008001",
        ...
        region="Moscow",
        address=None,
        customer_comment="Needs a range of sizes for children.",
        source="manual",
        responsible_id=102,
        sport="Tennis",
        product_category="Training apparel",
        need_description="Training shirts and shorts for the academy.",
        estimated_quantity=65,
        estimated_amount=Decimal("225000.00"),
        desired_date=date(2026, 8, 25),
    ),
    SeedLead(
        id=1009,
        status=LeadStatus.PROPOSAL,
        contact_name="Nikolay Orlov",
        company_name="Dev Rugby Strela",
        customer_type=LeadCustomerType.COMPANY,
        tax_id=None,
        website=None,
        phone="+79001009001",
        email="nikolay.orlov@example.test",
        city="Kazan",
        region="Tatarstan",
        address=None,
        customer_comment="Proposal is being reviewed by the board.",
        source="referral",
        responsible_id=101,
        sport="Rugby",
        product_category="Team uniform",
        need_description="Match kits for the regional league.",
        estimated_quantity=24,
        estimated_amount=Decimal("198000.00"),
        desired_date=date(2026, 9, 10),
    ),
    SeedLead(
        id=1010,
        status=LeadStatus.WAITING,
        contact_name="Irina Morozova",
        company_name="Dev MultiSport Event",
        customer_type=LeadCustomerType.COMPANY,
        tax_id=None,
        website="multisport-dev.example.test",
        phone="+79001010001",
        email="irina.morozova@example.test",
        city="Sochi",
        region="Krasnodar region",
        address=None,
        customer_comment="Waiting for final participant count.",
        source="event",
        responsible_id=102,
        sport="Multi-sport",
        product_category="Event merchandise",
        need_description="T-shirts and caps for a sports festival.",
        estimated_quantity=180,
        estimated_amount=Decimal("360000.00"),
